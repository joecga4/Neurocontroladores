...
etapa = 1;   % <-- EDITAR: 1 (cerca) -> 2 (medio) -> 3 (cobertura completa)
...
contmax  = 3000;    % Número máximo de iteraciones (épocas)
...
if( guardar == 1 )
    save redcarro11 nm v w c a;
    disp('Pesos guardados en redcarro11.mat');
end
