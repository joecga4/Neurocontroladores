% ControlDifusoLQRTrailer_MembresiaEstrecha (original: RedesNeuroDifusas/fuzzytrailerLQ.m)
% =========================================================================
% NOTA: variante de ControlDifusoLQRTrailer.m; la UNICA diferencia es
%   np1 = round(np/40)   (en vez de round(np/20))
% con lo que las mesetas saturadas de las membresias laterales
% (NEGATIVO/POSITIVO) son mas estrechas y las rampas de transicion hacia
% la membresia central mas anchas.
%
...
np1 = round(np/40);  % fin de la meseta de fdp1 / inicio de su rampa
