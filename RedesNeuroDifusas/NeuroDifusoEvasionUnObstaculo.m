% NeuroDifusoEvasionUnObstaculo (original: neurofuzzyObstacle1.m)
% =========================================================================
% Control neuro-difuso tipo Sugeno de orden cero (mismo nucleo que
% NeuroDifusoCarroPosicion.m) de un robot movil tipo carro que ademas
% evade UN obstaculo rectangular siguiendo un camino de referencia por
% tramos (poligonal de waypoints).
%
...
%% Camino por tramos para evadir el obstaculo
% El obstaculo es la franja X:25-75, Y:30-35. El camino de referencia es
% una poligonal de 4 vertices que lo rodea por el costado y termina en un
% tramo vertical hacia x = 50:
%
...
%     W3 = (88,35)   esquiva por fuera        xk' = 2*50 - xk
%     W4 = (75,48)   retorna tras el obstaculo
%     y >= 48: tramo final vertical hacia (50, arriba)
%
...
% entrada en x = 45..55 (el original rellenaba la primera franja dos
% veces; se omite el duplicado, el resultado visual es identico)
